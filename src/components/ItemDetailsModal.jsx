        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 items-start">
          <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-slate-950 border border-slate-800">
            ...
            {item.imageVisualFeatures && (
              <div className="absolute bottom-2 left-2 right-2 p-2 rounded-xl bg-slate-950/90 backdrop-blur-sm border border-slate-800 text-xs text-slate-200 flex items-center gap-1.5">
          ...
          <div className="space-y-3">
            ...
            <div className="pt-2 border-t border-slate-800 grid grid-cols-2 gap-2 text-xs text-slate-400">
              <div>
                <span className="text-slate-500 block text-[10px] font-bold uppercase">Brand / Make</span>
                <span className="text-white font-bold">{item.brand || "Unspecified"}</span>
              </div>
              <div>
                <span className="text-slate-500 block text-[10px] font-bold uppercase">Color / Finish</span>
